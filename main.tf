...
resource "aws_lambda_provisioned_concurrency_config" "current_version" {
  ...
  function_name = var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].function_name : aws_lambda_function.this[0].function_name
  qualifier     = var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].version : aws_lambda_function.this[0].version
...
resource "aws_lambda_function_event_invoke_config" "this" {
  ...
  function_name = var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].function_name : aws_lambda_function.this[0].function_name
  qualifier     = each.key == "current_version" ? var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].version : aws_lambda_function.this[0].version : null
...
resource "aws_lambda_function_url" "this" {
  ...
  qualifier          = var.create_unqualified_alias_lambda_function_url ? null : var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].version : aws_lambda_function.this[0].version
...
# Ignore Image URI
resource "aws_lambda_function" "ignore_image_uri" {
  count = local.create && var.create_function && !var.create_layer && var.ignore_image_uri ? 1 : 0
