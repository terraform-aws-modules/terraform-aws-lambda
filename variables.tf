...
variable "lambda_role" {
  description = "IAM role ARN attached to the Lambda Function. Only used when create_role = false; ignored otherwise. This governs both who / what can invoke your Lambda Function, as well as what resources our Lambda Function has access to. See Lambda Permission Model for more details."
  type        = string
  default     = ""
}
