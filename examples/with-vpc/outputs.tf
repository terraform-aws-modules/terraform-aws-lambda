...
output "lambda_function_code_sha256" {
  ...
  value       = module.lambda_function_in_vpc.lambda_function_code_sha256
}
...
output "lambda_layer_code_sha256" {
  ...
  value       = module.lambda_function_in_vpc.lambda_layer_code_sha256
}
...
output "lambda_layer_source_code_hash" {
  ...
  value       = module.lambda_function_in_vpc.lambda_layer_source_code_hash
}
