# AWS Lambda Function deployed from Docker Container Image with a different architecture example

Configuration in this directory creates AWS Lambda Function deployed with a Container Image with a different architecture than the build machine. This example is to help demonstrate how to build different platform architectures on a build machine like an ARM M1 Max Mac.
