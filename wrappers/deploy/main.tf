module "wrapper" {
  ...
  alias_name                      = try(each.value.alias_name, var.defaults.alias_name, null)
  function_name                   = try(each.value.function_name, var.defaults.function_name, null)
  current_version                 = try(each.value.current_version, var.defaults.current_version, null)
  target_version                  = try(each.value.target_version, var.defaults.target_version, null)
  before_allow_traffic_hook_arn   = try(each.value.before_allow_traffic_hook_arn, var.defaults.before_allow_traffic_hook_arn, null)
  after_allow_traffic_hook_arn    = try(each.value.after_allow_traffic_hook_arn, var.defaults.after_allow_traffic_hook_arn, null)
  ...
  app_name                        = try(each.value.app_name, var.defaults.app_name, null)
  ...
  codedeploy_role_name            = try(each.value.codedeploy_role_name, var.defaults.codedeploy_role_name, null)
