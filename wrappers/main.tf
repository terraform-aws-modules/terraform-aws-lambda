module "wrapper" {
  ...
  handler                                      = try(each.value.handler, var.defaults.handler, null)
  runtime                                      = try(each.value.runtime, var.defaults.runtime, null)
  lambda_role                                  = try(each.value.lambda_role, var.defaults.lambda_role, null)
  ...
  layer_name                                   = try(each.value.layer_name, var.defaults.layer_name, null)
  layer_skip_destroy                           = try(each.value.layer_skip_destroy, var.defaults.layer_skip_destroy, false)
  license_info                                 = try(each.value.license_info, var.defaults.license_info, null)
  ...
  hash_extra                                   = try(each.value.hash_extra, var.defaults.hash_extra, null)
  build_in_docker                              = try(each.value.build_in_docker, var.defaults.build_in_docker, false)
  docker_file                                  = try(each.value.docker_file, var.defaults.docker_file, null)
  docker_build_root                            = try(each.value.docker_build_root, var.defaults.docker_build_root, null)
  docker_image                                 = try(each.value.docker_image, var.defaults.docker_image, null)
