...
output "lambda_function_arn_static" {
  ...
  value       = module.aws_lambda_function.lambda_function_arn_static
}
...
output "lambda_function_qualified_invoke_arn" {
  ...
  value       = module.aws_lambda_function.lambda_function_qualified_invoke_arn
}
...
output "lambda_function_last_modified" {
  ...
  value       = module.aws_lambda_function.lambda_function_last_modified
}

output "lambda_function_kms_key_arn" {
  description = "The ARN for the KMS encryption key of Lambda Function"
  value       = module.aws_lambda_function.lambda_function_kms_key_arn
}

output "lambda_function_source_code_hash" {
  description = "Base64-encoded representation of raw SHA-256 sum of the zip file"
  value       = module.aws_lambda_function.lambda_function_source_code_hash
}

output "lambda_function_source_code_size" {
  description = "The size in bytes of the function .zip file"
  value       = module.aws_lambda_function.lambda_function_source_code_size
}

output "lambda_function_signing_job_arn" {
  description = "ARN of the signing job"
  value       = module.aws_lambda_function.lambda_function_signing_job_arn
}

output "lambda_function_signing_profile_version_arn" {
  description = "ARN of the signing profile version"
  value       = module.aws_lambda_function.lambda_function_signing_profile_version_arn
}
...
output "lambda_function_url_id" {
  ...
  value       = module.aws_lambda_function.lambda_function_url_id
}

# Lambda Layer
output "lambda_layer_arn" {
  description = "The ARN of the Lambda Layer with version"
  value       = module.aws_lambda_function.lambda_layer_arn
}

output "lambda_layer_layer_arn" {
  description = "The ARN of the Lambda Layer without version"
  value       = module.aws_lambda_function.lambda_layer_layer_arn
}

output "lambda_layer_created_date" {
  description = "The date Lambda Layer resource was created"
  value       = module.aws_lambda_function.lambda_layer_created_date
}

output "lambda_layer_source_code_size" {
  description = "The size in bytes of the Lambda Layer .zip file"
  value       = module.aws_lambda_function.lambda_layer_source_code_size
}

output "lambda_layer_version" {
  description = "The Lambda Layer version"
  value       = module.aws_lambda_function.lambda_layer_version
}
...
output "lambda_event_source_mapping_function_arn" {
  ...
  value       = module.aws_lambda_function.lambda_event_source_mapping_function_arn
}

output "lambda_event_source_mapping_state" {
  description = "The state of the event source mapping"
  value       = module.aws_lambda_function.lambda_event_source_mapping_state
}
...
output "lambda_event_source_mapping_state_transition_reason" {
  ...
  value       = module.aws_lambda_function.lambda_event_source_mapping_state_transition_reason
}

output "lambda_event_source_mapping_uuid" {
  description = "The UUID of the created event source mapping"
  value       = module.aws_lambda_function.lambda_event_source_mapping_uuid
}
...
output "lambda_role_unique_id" {
  ...
  value       = module.aws_lambda_function.lambda_role_unique_id
}

# CloudWatch Log Group
output "lambda_cloudwatch_log_group_arn" {
  description = "The ARN of the Cloudwatch Log Group"
  value       = module.aws_lambda_function.lambda_cloudwatch_log_group_arn
}
...
output "local_filename" {
  ...
  value       = module.aws_lambda_function.local_filename

}

output "s3_object" {
  description = "The map with S3 object data of zip archive deployed (if deployment was from S3)"
  value       = module.aws_lambda_function.s3_object
}
