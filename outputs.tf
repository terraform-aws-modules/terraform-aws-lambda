...
output "lambda_function_arn" {
  ...
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].arn : aws_lambda_function.this[0].arn, "")
}
...
output "lambda_function_invoke_arn" {
  ...
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].invoke_arn : aws_lambda_function.this[0].invoke_arn, "")
}

output "lambda_function_name" {
  description = "The name of the Lambda Function"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].function_name : aws_lambda_function.this[0].function_name, "")
}

output "lambda_function_qualified_arn" {
  description = "The ARN identifying your Lambda Function Version"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].qualified_arn : aws_lambda_function.this[0].qualified_arn, "")
}

output "lambda_function_qualified_invoke_arn" {
  description = "The Invoke ARN identifying your Lambda Function Version"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].qualified_invoke_arn : aws_lambda_function.this[0].qualified_invoke_arn, "")
}

output "lambda_function_version" {
  description = "Latest published version of Lambda Function"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].version : aws_lambda_function.this[0].version, "")
}

output "lambda_function_last_modified" {
  description = "The date Lambda Function resource was last modified"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].last_modified : aws_lambda_function.this[0].last_modified, "")
}

output "lambda_function_kms_key_arn" {
  description = "The ARN for the KMS encryption key of Lambda Function"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].kms_key_arn : aws_lambda_function.this[0].kms_key_arn, "")
}

output "lambda_function_source_code_hash" {
  description = "Base64-encoded representation of raw SHA-256 sum of the zip file"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].source_code_hash : aws_lambda_function.this[0].source_code_hash, "")
}

output "lambda_function_source_code_size" {
  description = "The size in bytes of the function .zip file"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].source_code_size : aws_lambda_function.this[0].source_code_size, "")
}

output "lambda_function_signing_job_arn" {
  description = "ARN of the signing job"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].signing_job_arn : aws_lambda_function.this[0].signing_job_arn, "")
}

output "lambda_function_signing_profile_version_arn" {
  description = "ARN of the signing profile version"
  value       = try(var.ignore_image_uri ? aws_lambda_function.ignore_image_uri[0].signing_profile_version_arn : aws_lambda_function.this[0].signing_profile_version_arn, "")
}
