...
| <a name="input_layer_name"></a> [layer\_name](#input\_layer\_name) | Name of Lambda Layer to create                                                                                                                                                                                              | `string` | `""` | no |
 | <a name="input_layer_skip_destroy"></a> [layer\_skip\_destroy](#input\_layer\_skip\_destroy) | Whether or not to skip destruction of previous layer versions. This is useful when sharing layers across an organization and preventing issues for downstream consumers                                                     | `bool` | `false` | no|
