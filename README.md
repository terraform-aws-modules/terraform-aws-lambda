...
| <a name="input_include_default_tag"></a> [include\_default\_tag](#input\_include\_default\_tag) | Set to false to not include the default tags in the tags map. | `bool` | `true` | no |
